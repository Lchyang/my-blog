...
SECRET_KEY = '+a*_jty#u(t#_l!#(xrfr#xv$ycp#(=wh6)fh55z%l-!u&8$hs'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')], # 配置django寻找模板的路径
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'NAME': 'my_blog',    ## 数据库名称
        'USER': 'root',
        'PASSWORD': 'li720333',    ## 安装 mysql 数据库时，输入的 root 用户的密码
        'HOST': '127.0.0.1',
    }
    # 'default': {
